...
var _initSlider = require("./modules/slider/init-slider");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/slider/init-slider":9,"./modules/tabs/init-tabs":10,"./modules/video/init-video":12,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
var getSlider = function getSlider() {
  ...
  var reviewsSlider;
  if (coachesSwiper) {
    coachesSlider = new _swiper.default(coachesSwiper, {
  ...
  if (reviewsSwiper) {
    reviewsSlider = new _swiper.default(reviewsSwiper, {
      direction: 'horizontal',
      loop: false,
      speed: 1000,
      breakpoints: {
