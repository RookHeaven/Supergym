...
require("./modules/video/index");
require("./modules/tabs/index");
require("./modules/slider/index");
require("./modules/carousel/index");
// ---------------------------------
...
},{"./modules/carousel/index":2,"./modules/form-validate/form":5,"./modules/slider/index":11,"./modules/tabs/index":13,"./modules/video/index":16,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";

var _initCarousel = require("./init-carousel");
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    (0, _initCarousel.getCarousel)();
  });
});

},{"./init-carousel":3}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCarousel = void 0;
...
var getCarousel = function getCarousel() {
  if (reviewsSwiper) {
    ...
    var swiper = new _swiper.default(reviewsSwiper, {
...
},{"../../vendor/swiper":20}],4:[function(require,module,exports){
"use strict";
...
var _initSlider = require("./init-slider");
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    (0, _initSlider.getSlider)();
  });
});

},{"./init-slider":12}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var coachesSwiper = document.querySelector('.coaches__swiper');
var coachesButtonPrev = document.querySelector('.coaches__button--prev');
var coachesButtonNext = document.querySelector('.coaches__button--next');
var getSlider = function getSlider() {
  if (coachesSwiper) {
    // eslint-disable-next-line
    var swiper = new _swiper.default(coachesSwiper, {
      direction: 'horizontal',
      loop: true,
      slidesPerView: 4,
      spaceBetween: 40,
...
},{"./init-tabs":14}],14:[function(require,module,exports){
"use strict";
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    (0, _initVideo.onPlayClick)();
  });
});

},{"./init-video":17}],17:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onPlayClick = void 0;
var videoBtn = document.querySelector('.video__button');
...
exports.onPlayClick = onPlayClick;
